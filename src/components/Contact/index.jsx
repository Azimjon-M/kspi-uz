...
const ContactUs = () => {
    return (
        <div>
            <h2 className="text-xl md:text-2xl lg:text-3xl tracking-tight font-extrabold text-center text-[#004269] dark:text-white">Biz bilan bog'lanish</h2>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:items-center'>
                <div className='bg-white dark:bg-gray-900'>
                    <div className="py-2 lg:py-6 px-4 mx-auto max-w-screen-md">
                        <p className="py-2 text-lg font-bold lg:mb-16 text-center text-[#004269] dark:text-gray-400 sm:text-xl">Aloqa va joylashuv</p>
                        <div>
                            <div className='flex items-center mb-5 md:mb-10'>
                                <FaMapLocationDot className='w-[40px] md:w-[60px] h-auto mr-4' />
                                <p className='text-[#004269]'>Qo'qon shaxri, Turon ko'chasi, 23-uy</p>
                            </div>
                            <div className='flex items-center mb-5 md:mb-10'>
                                <FaSquarePhone className='w-[40px] md:w-[60px] h-auto mr-4' />
                                <p className='text-[#004269]'>+998735423838</p>
                            </div>
                            <div className='flex items-center'>
                                <MdMarkEmailUnread className='w-[40px] md:w-[60px] h-auto mr-4' />
                                <p className='text-[#004269]'>kspi_info@edu.uz</p>
                            </div>
                        </div>
                    </div>
                </div>
                <section className="bg-white dark:bg-gray-900">
                    <div className="py-2 lg:py-6 px-4 mx-auto max-w-screen-md">
                    <p className="py-2 text-lg font-bold lg:mb-16 text-center text-[#004269] dark:text-gray-400 sm:text-xl">Taklif va shikoyatlaringizni yuboring</p>
                        <form action="#" className="space-y-8">
                            <div>
                                <label for="email" className="block mb-2 text-sm font-medium text-[#004269] dark:text-gray-300">Email</label>
                            ...
                            <div>
                                <label for="subject" className="block mb-2 text-sm font-medium text-[#004269] dark:text-gray-300">Mavzu</label>
                            ...
                            <div className="sm:col-span-2">
                                <label for="message" className="block mb-2 text-sm font-medium text-[#004269] dark:text-gray-400">Xabar</label>
