  ...
  return (
    <div className="max-w-7xl mx-auto pb-20">
      ...
      <div className="text-center">
        <Link to="/barchaElonlar" className="text-lg md:text-2xl bg-slate-100 text-cyan-900 font-bold active:border border-slate-100 px-10 md:px-28 py-2 md:py-4 rounded-xl">
          Barcha elonlar
        </Link>
      </div>
    </div>
