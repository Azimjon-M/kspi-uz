...
import kspi from "../../assets/images/kspi-img1.jpg";
      ...
      <div>
        <div className="max-w-7xl mx-auto mb-3">
          ...
          <div className="my-1 md:my-3">
            ...
            <h3 className="text-lg md:text-xl font-bold my-2 text-[#004269] text-center">
              Qo’qon davlat pedagogika instituti 92 yoshda!
            </h3>
          </div>
          <div>
            <img
              className="md:w-[50%] float-left md:mr-5 rounded mb-5 md:mb-0"
              src={kspi}
              alt=""
            />
            <p className="mb-3">
