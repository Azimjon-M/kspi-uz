...
const RekvizitlarCom = () => {
  return (
    <div className="px-5 py-3 md:px-10 mx-auto max-w-7xl mt-10">
      ...
      >
        ...
        <tbody>
          ...
          <tr>
            <td colSpan="2">
              <p className="md:text-lg font-semibold">Ro’yxatdan o’tkazilgan sana: 01.01.1931-yil</p>
          ...
          <tr>
            <td colSpan="2">
              <p className="md:text-lg font-semibold">O’zR Moliya vazirligi G’aznachiligi</p>
              <p className="md:text-lg font-semibold">h/r 23402000300100001010</p>
              <p className="md:text-lg font-semibold">INN: 201122919</p>
              <p className="md:text-lg font-semibold">Markaziy bank HKKM Toshkent shaxar boshqarmasi</p>
              <p className="md:text-lg font-semibold">MFO 00014</p>
              <p className="md:text-lg font-semibold">Qo’qon davlat pedagogika instituti</p>
              <p className="md:text-lg font-semibold">INN: 200131171 IFUT: 85420</p>
            </td>
          </tr>
        </tbody>
      </table>
